# ---
# ROBUSTNESS: LIMITING THE ANALYSIS TO NEIGHBOURHOODS WITH LOW SHARE OF NON-WESTERN STUDENTS
# ---
...
#SPECIFY PATHS
tables_path <- "tables/supp/r_low_pnw/"
plots_path <- "plots/main/supp/r_low_pnw/"
...
# LIMIT DATA TO SCHOOLS IN NEIGHBOURHOODS WITH NO MORE THAN 30% FOREIGN BORN RESIDENTS
total_df <- total_df %>%
  filter(prop_non_western <= 0.3)
