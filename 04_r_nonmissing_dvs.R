# ---
# ROBUSTNESS: RUNNING THE ANALYSIS ON STUDENTS WHO TOOK ALL THREE TESTS (NON-MISSING ON EITHER TEST)
# ---
...
#SPECIFY PATHS
tables_path <- "tables/supp/r_nonmissing_dvs/"
...
# LIMIT DATA TO NON-MISSING ACROSS ALL DVS 
total_df <- total_df %>%
  filter(!is.na(ALL) & !is.na(SP) & !is.na(RW) & !is.na(TBL))
